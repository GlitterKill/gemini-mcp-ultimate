...
::: warning 💡 gemini-mcp-tool-patched is tested extensively with claude code
:::
...
::: info Need Help?
If you run into issues, [open an issue](https://github.com/GlitterKill/gemini-mcp-tool-patched/issues) on GitHub.
:::
