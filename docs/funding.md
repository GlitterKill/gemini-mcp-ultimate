...
<div class="funding-card">
  ...
  <ul>
    ...
    <li><strong>API Testing Credits:</strong> Funds are used for testing various deployements of gemini-mcp-tool-patched on popular clients.</li>
  </ul>
...
<div class="support-options" style="margin: 32px auto; max-width: 600px;">
  <a href="https://github.com/sponsors/GlitterKill" target="_blank" rel="noopener" class="support-button support-button--primary">
  ...
  <a href="https://ko-fi.com/GlitterKill" target="_blank" rel="noopener" class="support-button support-button--secondary">
